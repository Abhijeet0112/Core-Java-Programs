...
public class MyMainClass {
	...
	public static void main(String[] args) {
		...
		SortByNameAndSalary sort2 = new SortByNameAndSalary();
		Collections.sort(employee,sort2);
		System.out.println("After Sorting by name and salary and name in ascending order");
		for(Employee e : employee) {
			System.out.println(e);
		}
	}
